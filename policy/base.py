...
class BaseMPC:
  ...
  def create_mpc_solver(self):
    def func(x, U, params, cost_args, dynamics_args):
      return opt.ilqr_solve(self.cost, self.dynamics, x, U,
        params, cost_args, dynamics_args, self.trajax_ilqr_kwargs)
    return jax.jit(func)
  ...
  def dynamics(self, x, u, t, params, *args):
    ...
    return self.dynamics_model.predict(
      x, u, t, dynamics_params, *args
    )
  ...
  def loss_and_grad(self, X, params, loss_vmap, batch_loss_args):
    ...
    def func(x0, params, loss_args):
      ...
      cost_args = (goal_X,)
      dynamics_args = ()
      (high_level_loss, low_level_grad, high_level_grad, itr) = (
        opt.bilevel_optimization(
            self.cost, self.dynamics, self.loss,
            x0, init_U, params,
            cost_args, dynamics_args, loss_args,
